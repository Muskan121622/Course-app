...
//         `http://localhost:1227/api/v1/user/signup`,
//         {
//           firstName,
//           lastName,
//           email,
...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://course-app-3-17w5.onrender.com/api/v1/user/signup`,
    ...
    <div className="bg-gradient-to-r from-black to-blue-950">
      <div className="h-screen container mx-auto flex items-center justify-center text-white">
        ...
        <header className="absolute top-0 left-0 w-full flex justify-between items-center p-5">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/login" className="border border-gray-500 p-2 rounded-md">
              Login
            </Link>
            <Link to="/courses" className="bg-orange-500 p-2 rounded-md">
              Join now
            </Link>
          </div>
        </header>
