...
//           `https://course-app-4-hb1g.onrender.com/api/v1/course/buy/${courseId}`,
//           {},
//           {
//             headers: {
...
//       try {
//         await axios.post(`https://course-app-4-hb1g.onrender.com/api/v1/order`, paymentInfo, {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
//           withCredentials: true,
...
//       try {
//         await axios.post(
//           `https://course-app-4-hb1g.onrender.com/api/v1/order`,
//           {
//             email: user?.user?.email,
//             userId: user.user._id,
//             courseId,
...
//         // Ensure we still have user in localStorage before navigating
//         const stillUser = localStorage.getItem("user");
//         if (!stillUser) {
//           localStorage.setItem("user", JSON.stringify(user)); // Restore if cleared
//         }

//         navigate("/purchases"); // Navigate without delay
//       } catch (err) {
//         console.error(err);
  ...
  const handlePurchase = async (event) => {
    ...
    if (paymentIntent?.status === "succeeded") {
      ...
      try {
        ...
        // Optional: Refresh local user storage
        localStorage.setItem("user", JSON.stringify(user));

        // Delay redirect to let UI sync
        setTimeout(() => {
          window.scrollTo(0, 0);
          navigate("/purchases");
        }, 1000);
