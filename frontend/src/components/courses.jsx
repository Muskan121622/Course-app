...
function Courses() {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        const response = await axios.get("https://course-app-2-mrpv.onrender.com/api/v1/course/courses", { withCredentials: true });
  ...
  const handleLogout = async () => {
    try {
      const response = await axios.get("https://course-app-2-mrpv.onrender.com/api/v1/user/logout", { withCredentials: true });
